...
func _process(delta: float) -> void:
	if %DialogicNode_NameLabel.text != "":
		$Anchor/AnimationParent/Sizer/TextureRect4.show()
		$Anchor/AnimationParent/Sizer/NameLabelHolder.show()
	else:
		$Anchor/AnimationParent/Sizer/NameLabelHolder.hide()
		$Anchor/AnimationParent/Sizer/TextureRect4.hide()
